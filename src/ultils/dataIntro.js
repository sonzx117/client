export const text = {
  title: "Tại sao lại chọn PhongTro Hoàng Sơn",
  description:
    "Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng PhongTro Hoàng Sơn tự hào là trang web đứng top google về các từ khóa: ",
  description2:
